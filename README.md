...
A modern, responsive landing page for a creative studio, built primarily with **Bootstrap 5**.
...
- **Mock Dashboard**: A detailed, code-only representation of a SaaS dashboard within the Hero section.
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/karungofaith3-hash/Beautiful-Art-project.git
   ```
2. **Open `index.html`**:
